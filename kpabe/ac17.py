...
class AC17CPABE(ABEnc):
    ...
    def encrypt(self, pk, msg, policy_str):
        ...
        # print(mono_span_prog)
        # print(num_cols)
        # print(self.util.getCoefficients(policy))
    ...
    def decrypt(self, pk, ctxt, key):
        ...
        for i in range(self.assump_size + 1):
            ...
            for node in nodes:
                ...
                prod_H *= key['K'][attr_stripped][i] #den
                prod_G *= ctxt['C'][attr][i] #num
            prod1_GT *= pair(key['Kp'][i] * prod_H, ctxt['C_0'][i]) #den
            prod2_GT *= pair(prod_G, key['K_0'][i]) #num
